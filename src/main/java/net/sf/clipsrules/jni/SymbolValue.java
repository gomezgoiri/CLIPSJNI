 ...
 * A semicolon “;” starts a CLIPS comment and also acts as a de­limiter.
 ...
 * In addition, a symbol may not begin with either the “?” character or the “$?” sequence of characters (although a symbol may contain these characters).
 * These characters are reserved for variables (which are discussed later in this section). CLIPS is case sensitive (i.e. uppercase letters will match only uppercase let­ters).
 ...
 * </p>
 * 
 * <p>Some simple examples of symbols are:</p>
 * <ul>
 * 		<li>foo</li>
 * 		<li>Hello</li>
 * 		<li>B76-HI</li>
