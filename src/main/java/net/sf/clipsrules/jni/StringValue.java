 ...
 * Double quotes may be embedded within a string by placing a backslash (\) in front of the character.
 * A backslash may be embedded by placing two consecutive back­slash characters in the string.
 * </p>
 * 
 ...
 *  
 *  <p>
 *  Note that the string “abcd" is not the same as the symbol abcd.
 *  They both contain the same characters, but are of different types.
 *  The same holds true for the instance name [abcd].
 *  </p>
 */
