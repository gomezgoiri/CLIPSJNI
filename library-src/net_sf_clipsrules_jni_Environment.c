...
/**************************************************/
/* Java_net_sf_clipsrules_jni_Environment_run: Native function */ 
...
/****************************************************/
/* Java_net_sf_clipsrules_jni_Environment_build: Native function */
...
jint throwCLIPSError2(void *theEnv, char *module, int errorID, char *message)
{
    ...
    exClass = (*env)->FindClass( env, "net/sf/clipsrules/jni/CLIPSError");
    if (exClass == NULL) {
	//B plan: null pointer ...
	exClass = (*env)->FindClass( env, "java/lang/NoClassDefFoundError");
	return (*env)->ThrowNew( env, exClass, "net/sf/clipsrules/jni/CLIPSError not found" );
    } else {
